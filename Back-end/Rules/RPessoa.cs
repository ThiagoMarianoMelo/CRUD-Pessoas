...
namespace RestAPIModel.Rules.RPessoa{
    ...
    public class RPessoa{
        ...
        //pensar numa forma de pegar o ID e assim não precisar passar pelo nome
        //MOTIVO: FRONT-END NÃO ARMAZENA O ID ...
        //SOLUÇÃO: PODERIA PASSAR IDADE E ALTURA MAS AINDA NÃO É FUNCIONAL!!!
